...
// cacheSize calculates and returns the size of the rifthash verification cache that
...
// datasetSize calculates and returns the size of the rifthash mining dataset that
