...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db riftdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db riftdb.Database) error {
