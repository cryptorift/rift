...
import (
	...
	"github.com/cryptorift/riftcore/crypto/sha3"
...
// ecrecover extracts the CryptoRift account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the CryptoRift address
...
// CryptoRift testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     riftdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // CryptoRift address of the signing key
...
func New(config *params.CliqueConfig, db riftdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the CryptoRift address recovered
