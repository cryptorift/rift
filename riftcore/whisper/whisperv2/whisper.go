...
import (
	...
	"github.com/cryptorift/riftcore/crypto/ecies"
	"github.com/cryptorift/riftcore/event/filter"
...
// Whisper represents a dark communication interface through the CryptoRift
...
// New creates a Whisper client ready to communicate through the CryptoRift P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
