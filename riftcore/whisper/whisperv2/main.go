...
import (
	...
	"github.com/cryptorift/riftcore/logger"
	"github.com/cryptorift/riftcore/p2p"
	"github.com/cryptorift/riftcore/p2p/nat"
	"github.com/cryptorift/riftcore/whisper"
)
...
func main() {
	...
	// Create an CryptoRift peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting CryptoRift peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start CryptoRift peer: %v.\n", err)
		os.Exit(1)
	}
