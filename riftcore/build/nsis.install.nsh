Name "riftcmd ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/cryptorift/riftcore/issues"
!define UPDATEURL "https://github.com/cryptorift/riftcore/releases"
!define ABOUTURL "https://github.com/cryptorift/riftcore#cryptorift-go"
...
# Install riftcmd binary
Section "Riftcmd" RIFTCMD_IDX
  SetOutPath $INSTDIR
  file {{.Riftcmd}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\riftcmd.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\riftcmd.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Riftcmd incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Riftcmd outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Riftcmd UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Riftcmd incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\riftcmd.exe" "" "" "CryptoRift" 30303 "" "" ""
  SimpleFC::AdvAddRule "Riftcmd outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\riftcmd.exe" "" "" "CryptoRift" "" 30303 "" ""
  SimpleFC::AdvAddRule "Riftcmd UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\riftcmd.exe" "" "" "CryptoRift" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/cryptorift/EIPs/issues/147)
  ${EnvVarUpdate} $0 "CRYPTORIFT_SOCKET" "R" "HKLM" "\\.\pipe\riftcmd.ipc"
  ${EnvVarUpdate} $0 "CRYPTORIFT_SOCKET" "A" "HKLM" "\\.\pipe\riftcmd.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${RIFTCMD_IDX}
    SectionGetSize ${RIFTCMD_IDX} $0
