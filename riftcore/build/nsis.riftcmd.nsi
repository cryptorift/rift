...
# 1. install riftcmd for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for riftcmd
# 5. create riftcmd, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable CRYPTORIFT_SOCKET
...
!define GROUPNAME "CryptoRift"
!define APPNAME "Riftcmd"
!define DESCRIPTION "Official Go implementation of the CryptoRift protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since riftcmd is installed global
