...
// Contains a wrapper for the CryptoRift client.
...
// CryptoRiftClient provides access to the CryptoRift APIs.
type CryptoRiftClient struct {
	client *riftclient.Client
}

// NewCryptoriftClient connects a client to the given URL.
func NewCryptoriftClient(rawurl string) (client *CryptoRiftClient, _ error) {
	rawClient, err := riftclient.Dial(rawurl)
	return &CryptoRiftClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *CryptoRiftClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *CryptoRiftClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *CryptoRiftClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *CryptoRiftClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *CryptoRiftClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *CryptoRiftClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *CryptoRiftClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *CryptoRiftClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *CryptoRiftClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *CryptoRiftClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *CryptoRiftClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *CryptoRiftClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *CryptoRiftClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *CryptoRiftClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *CryptoRiftClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *CryptoRiftClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *CryptoRiftClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *CryptoRiftClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *CryptoRiftClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *CryptoRiftClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *CryptoRiftClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *CryptoRiftClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *CryptoRiftClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *CryptoRiftClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *CryptoRiftClient) EstimateGas(ctx *Context, msg *CallMsg) (gas *BigInt, _ error) {
...
func (ec *CryptoRiftClient) SendTransaction(ctx *Context, tx *Transaction) error {
