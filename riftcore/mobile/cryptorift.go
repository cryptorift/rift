...
// Contains all the wrappers from the riftcore root package.
...
// the CryptoRift network.
type SyncProgress struct {
	progress cryptorift.SyncProgress
}
