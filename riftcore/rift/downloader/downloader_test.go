...
type downloadTester struct {
	...
	stateDb riftdb.Database // Database used by the tester for syncing from peers
	peerDb  riftdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = riftdb.NewMemDatabase()
