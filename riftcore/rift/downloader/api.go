...
// Syncing provides information when this nodes starts synchronising with the CryptoRift network and when it's finished.
...
type SyncingResult struct {
	...
	Status  cryptorift.SyncProgress `json:"status"`
}
