...
var ProtocolName = "rift"

// Supported versions of the rift protocol (first is primary).
var ProtocolVersions = []uint{rift63, rift62}
...
// rift protocol message codes
const (
	// Protocol messages belonging to rift/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to rift/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
