...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (rift/61) or header (rift/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (rift/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both rift/61 and rift/62)
}
