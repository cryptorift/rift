...
// PeerInfo represents a short summary of the CryptoRift sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // CryptoRift protocol version negotiated
...
// Handshake executes the rift protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("rift/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the CryptoRift sub-protocol.
type peerSet struct {
