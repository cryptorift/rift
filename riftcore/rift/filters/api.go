...
// information related to the CryptoRift protocol such als blocks, transactions and logs.
...
// `rift_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/cryptorift/wiki/wiki/JSON-RPC#rift_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with rift_getFilterChanges.
//
// https://github.com/cryptorift/wiki/wiki/JSON-RPC#rift_newblockfilter
...
//
// https://github.com/cryptorift/wiki/wiki/JSON-RPC#rift_newfilter
...
//
// https://github.com/cryptorift/wiki/wiki/JSON-RPC#rift_getlogs
...
//
// https://github.com/cryptorift/wiki/wiki/JSON-RPC#rift_uninstallfilter
...
//
// https://github.com/cryptorift/wiki/wiki/JSON-RPC#rift_getfilterlogs
...
//
// https://github.com/cryptorift/wiki/wiki/JSON-RPC#rift_getfilterchanges
