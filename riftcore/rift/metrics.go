...
var (
	...
	miscInPacketsMeter        = metrics.NewMeter("rift/misc/in/packets")
	miscInTrafficMeter        = metrics.NewMeter("rift/misc/in/traffic")
	miscOutPacketsMeter       = metrics.NewMeter("rift/misc/out/packets")
	miscOutTrafficMeter       = metrics.NewMeter("rift/misc/out/traffic")
)
...
func (rw *meteredMsgReadWriter) ReadMsg() (p2p.Msg, error) {
	...
	case rw.version >= rift63 && msg.Code == NodeDataMsg:
		packets, traffic = reqStateInPacketsMeter, reqStateInTrafficMeter
	case rw.version >= rift63 && msg.Code == ReceiptsMsg:
