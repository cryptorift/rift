...
const (
	...
	EPOLL_CTL_MOD                    = 0x3
	RIFT_P_1588                       = 0x88f7
	RIFT_P_8021AD                     = 0x88a8
	RIFT_P_8021AH                     = 0x88e7
	RIFT_P_8021Q                      = 0x8100
	RIFT_P_80221                      = 0x8917
	RIFT_P_802_2                      = 0x4
	RIFT_P_802_3                      = 0x1
	RIFT_P_802_3_MIN                  = 0x600
	RIFT_P_802_EX1                    = 0x88b5
	RIFT_P_AARP                       = 0x80f3
	RIFT_P_AF_IUCV                    = 0xfbfb
	RIFT_P_ALL                        = 0x3
	RIFT_P_AOE                        = 0x88a2
	RIFT_P_ARCNET                     = 0x1a
	RIFT_P_ARP                        = 0x806
	RIFT_P_ATALK                      = 0x809b
	RIFT_P_ATMFATE                    = 0x8884
	RIFT_P_ATMMPOA                    = 0x884c
	RIFT_P_AX25                       = 0x2
	RIFT_P_BATMAN                     = 0x4305
	RIFT_P_BPQ                        = 0x8ff
	RIFT_P_CAIF                       = 0xf7
	RIFT_P_CAN                        = 0xc
	RIFT_P_CANFD                      = 0xd
	...
	RIFT_P_DEC                        = 0x6000
	RIFT_P_DIAG                       = 0x6005
	RIFT_P_DNA_DL                     = 0x6001
	RIFT_P_DNA_RC                     = 0x6002
	RIFT_P_DNA_RT                     = 0x6003
	RIFT_P_DSA                        = 0x1b
	RIFT_P_ECONET                     = 0x18
	RIFT_P_EDSA                       = 0xdada
	RIFT_P_FCOE                       = 0x8906
	...
	RIFT_P_HDLC                       = 0x19
	RIFT_P_HSR                        = 0x892f
	RIFT_P_IEEE802154                 = 0xf6
	RIFT_P_IEEEPUP                    = 0xa00
	RIFT_P_IEEEPUPAT                  = 0xa01
	RIFT_P_IP                         = 0x800
	RIFT_P_IPV6                       = 0x86dd
	RIFT_P_IPX                        = 0x8137
	RIFT_P_IRDA                       = 0x17
	RIFT_P_LAT                        = 0x6004
	RIFT_P_LINK_CTL                   = 0x886c
	RIFT_P_LOCALTALK                  = 0x9
	RIFT_P_LOOP                       = 0x60
	RIFT_P_LOOPBACK                   = 0x9000
	RIFT_P_MACSEC                     = 0x88e5
	RIFT_P_MOBITEX                    = 0x15
	RIFT_P_MPLS_MC                    = 0x8848
	RIFT_P_MPLS_UC                    = 0x8847
	RIFT_P_MVRP                       = 0x88f5
	RIFT_P_PAE                        = 0x888e
	RIFT_P_PAUSE                      = 0x8808
	RIFT_P_PHONET                     = 0xf5
	RIFT_P_PPPTALK                    = 0x10
	RIFT_P_PPP_DISC                   = 0x8863
	RIFT_P_PPP_MP                     = 0x8
	RIFT_P_PPP_SES                    = 0x8864
	RIFT_P_PRP                        = 0x88fb
	RIFT_P_PUP                        = 0x200
	RIFT_P_PUPAT                      = 0x201
	RIFT_P_QINQ1                      = 0x9100
