...
// Package bind generates CryptoRift contract Go bindings.
//
// Detailed usage document and tutorial available on the riftcore Wiki page:
// https://github.com/cryptorift/riftcore/wiki/Native-DApps:-Go-bindings-to-CryptoRift-contracts
package bind
