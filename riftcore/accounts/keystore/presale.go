...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/cryptorift/pyethsaletool
	...
	*/
	...
	riftPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(riftPriv)
	...
	expectedAddr := preSaleKeyStruct.RiftAddr
