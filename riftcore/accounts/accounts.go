...
// Package accounts implements high level CryptoRift account management.
package accounts
...
// Account represents an CryptoRift account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // CryptoRift account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain cryptorift.ChainStateReader)
