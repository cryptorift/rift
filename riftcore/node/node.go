...
func New(conf *Config) (*Node, error) {
	...
	// We rely on this in cmd/riftcmd.
...
func (n *Node) OpenDatabase(name string, cache, handles int) (riftdb.Database, error) {
	if n.config.DataDir == "" {
		return riftdb.NewMemDatabase()
	}
	return riftdb.NewLDBDatabase(n.config.resolvePath(name), cache, handles)
}
