...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "riftcmd.ipc", false, filepath.Join(os.TempDir(), "riftcmd.ipc")},
		{"data", "riftcmd.ipc", false, "data/riftcmd.ipc"},
		{"data", "./riftcmd.ipc", false, "./riftcmd.ipc"},
		{"data", "/riftcmd.ipc", false, "/riftcmd.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "riftcmd.ipc", true, `\\.\pipe\riftcmd.ipc`},
		{"data", "riftcmd.ipc", true, `\\.\pipe\riftcmd.ipc`},
		{"data", `\\.\pipe\riftcmd.ipc`, true, `\\.\pipe\riftcmd.ipc`},
	}
