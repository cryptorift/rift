...
// Package types contains data types related to CryptoRift consensus.
package types
...
// Header represents a block header in the CryptoRift blockchain.
type Header struct {
...
// Block represents an entire block in the CryptoRift blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package rift to track
...
// [deprecated by rift/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for rift protocol, etc.
...
// DecodeRLP decodes the CryptoRift
...
// EncodeRLP serializes b into the CryptoRift RLP block format.
