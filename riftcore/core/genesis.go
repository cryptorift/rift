...
func SetupGenesisBlock(db riftdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) Commit(db riftdb.Database) (*types.Block, error) {
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db riftdb.Database) *types.Block {
...
func GenesisBlockForTesting(db riftdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the CryptoRift main net genesis block.
...
// DevGenesisBlock returns the 'riftcmd --dev' genesis block.
