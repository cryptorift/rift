...
// stateObject represents an CryptoRift account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of cryptorift address of the account
	data     Account
	db       *StateDB
...
// Account is the CryptoRift consensus representation of accounts.
