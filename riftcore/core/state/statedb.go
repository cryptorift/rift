...
// Package state provides a caching layer atop the CryptoRift state trie.
package state
...
// StateDBs within the cryptorift protocol are used to store anything
...
//
// Carrying over the balance ensures that Rifter doesn't disappear.
