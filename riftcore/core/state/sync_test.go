...
func makeTestState() (Database, *riftdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := riftdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db riftdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db riftdb.Database, root common.Hash) error {
...
func checkStateConsistency(db riftdb.Database, root common.Hash) error {
