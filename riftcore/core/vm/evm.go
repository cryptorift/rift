...
type Context struct {
	...
	// sufficient rifter to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers rifter from one account to the other
...
// EVM is the CryptoRift Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) cryptorift virtual machine
