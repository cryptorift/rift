...
// setting up a new or managing an existing CryptoRift private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your CryptoRift private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new CryptoRift network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and riftstats servers |")
	...
	log.Info("Administering CryptoRift network", "name", w.network)
