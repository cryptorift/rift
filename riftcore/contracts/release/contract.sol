...
// ReleaseOracle is an CryptoRift contract to store the current and previous
// versions of the riftcore implementation. Its goal is to allow Riftcmd to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Riftcmd releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Riftcmd release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an CryptoRift user, either
