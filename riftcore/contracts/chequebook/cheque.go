...
// Package chequebook package wraps the 'chequebook' CryptoRift smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in rifter; (auto)cashing cheques in rifter
// as well as (auto)depositing rifter to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/cryptorift/riftcore/contracts/chequebook/contract"
	"github.com/cryptorift/riftcore/core/types"
	"github.com/cryptorift/riftcore/crypto"
	"github.com/cryptorift/riftcore/log"
	"github.com/cryptorift/riftcore/swarm/services/swap/swap"
)
...
// * depositing rifter to the chequebook
// * watching incoming rifter
...
// Cash cashes the cheque by sending an CryptoRift transaction.
