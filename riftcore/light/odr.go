...
type OdrBackend interface {
	Database() riftdb.Database
	Retrieve(ctx context.Context, req OdrRequest) error
}

// OdrRequest is an interface for retrieval requests
type OdrRequest interface {
	StoreResult(db riftdb.Database)
}
...
func (req *TrieRequest) StoreResult(db riftdb.Database) {
	storeProof(db, req.Proof)
}

// storeProof stores the new trie nodes obtained from a merkle proof in the database
func storeProof(db riftdb.Database, proof []rlp.RawValue) {
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db riftdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db riftdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db riftdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db riftdb.Database) {
