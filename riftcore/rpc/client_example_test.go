...
//
// rift_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// rift_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.RiftSubscribe(ctx, subch, "newBlocks")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "rift_getBlockByNumber", "latest"); err != nil {
